...
Thông báo công việc có thể xuất hiện trên màn hình khóa. Bấm vào thông báo chỉ đóng thông báo, không tự mở trình duyệt hoặc ứng dụng, giúp tránh làm chậm thiết bị. Khi cần xem chi tiết, người dùng chủ động mở màn hình `Thông báo`.
